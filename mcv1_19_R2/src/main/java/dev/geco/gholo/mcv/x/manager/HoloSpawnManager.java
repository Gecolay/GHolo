...
import org.bukkit.craftbukkit.v1_19_R2.util.*;
            ...
            for(Entry<GHolo, List<GHoloRow>> holoEntry : holos.entrySet()) {
                ...
                for(GHoloRow holoRow : holoEntry.getValue()) {
                    ...
                    for(Player player : players) {
                        ...
                        try { holoRow.getBase().setCustomName(CraftChatMessage.fromString(text)[0]); } catch (Exception ignored) { ignored.printStackTrace(); }
