...
public class GHoloTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender s, Command c, String l, String[] a) {
        ...
        if(a.length == 1) {
            ...
            if(s.hasPermission(GPM.NAME + ".Holo") || s.hasPermission(GPM.NAME + ".*")) {
                if(a[0].equalsIgnoreCase("info") || a[0].equalsIgnoreCase("remove") || a[0].equalsIgnoreCase("tp") || a[0].equalsIgnoreCase("tphere") || a[0].equalsIgnoreCase("tpto") || a[0].equalsIgnoreCase("addrow") || a[0].equalsIgnoreCase("removerow") || a[0].equalsIgnoreCase("setrow") || a[0].equalsIgnoreCase("insertrow") || a[0].equalsIgnoreCase("copy") || a[0].equalsIgnoreCase("range") || a[0].equalsIgnoreCase("align") || a[0].equalsIgnoreCase("condition") || a[0].equalsIgnoreCase("image")) for(Holo h : GPM.getHoloManager().getHolos().values()) ta.add(h.getId());
            ...
            if(s.hasPermission(GPM.NAME + ".Holo") || s.hasPermission(GPM.NAME + ".*")) {
                if(a[0].equalsIgnoreCase("removerow") || a[0].equalsIgnoreCase("setrow") || a[0].equalsIgnoreCase("insertrow")) {
                    Holo h = GPM.getHoloManager().getHolo(a[1]);
                    if(h != null) for(int i = 1; i <= h.getContent().size(); i++) ta.add("" + i);
                }
                if(a[0].equalsIgnoreCase("copy")) for(Holo h : GPM.getHoloManager().getHolos().values()) ta.add(h.getId());
            ...
            if(s.hasPermission(GPM.NAME + ".Holo") || s.hasPermission(GPM.NAME + ".*")) {
                if(a[0].equalsIgnoreCase("align")) for(Holo h : GPM.getHoloManager().getHolos().values()) ta.add(h.getId());
                if(a[0].equalsIgnoreCase("image")) {
                    ...
                    if(a[2].equalsIgnoreCase("file")) for(String t : ImageUtil.IMAGE_PATH.list()) ta.add(t);
                }
            }
            if(!a[a.length - 1].isEmpty()) {
                for(String r : ta) if(r.toLowerCase().startsWith(a[a.length - 1].toLowerCase())) ts.add(r);
