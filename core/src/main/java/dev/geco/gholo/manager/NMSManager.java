...
public class NMSManager {
    ...
    public static Object getPackageObject(String ClassName, Object O) {
        ...
        try {
            ...
            Class<?> sm = Class.forName("dev.geco.gholo.mcv." + NMSManager.getPackageVersion() + "." + ClassName);
    ...
    public static boolean hasPackageClass(String ClassName) {
        try {
            Class.forName("dev.geco.gholo.mcv." + NMSManager.getPackageVersion() + "." + ClassName);
            return true;
